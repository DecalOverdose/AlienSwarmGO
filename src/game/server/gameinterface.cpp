		...
		CGlobalVars *pGlobals)
{
...
#endif
	// DecalOverdose: Steam is causing so many issues
#if 0
	...
	if ( !g_pMatchFramework )
		return false;
	// DecalOverdose: Thanks to ThePixelMoon for helping me find the bug that was crashing shit
#if 0
...
bool CServerGameClients::ClientReplayEvent(edict_t* pEntity, const ClientReplayEventParams_t& params)
{
	return false;
}
